    ...
    <div className={styles.embla}>
      <div className="embla__viewport" ref={emblaRef}>
        <div className={styles.embla__container}>
          <div
            className={`${styles.embla__slide} bg-[--primary-blue] text-white`}
          >
            <div className={`container-viva ${theme.hero_container}`}>
              <div className="md:w-3/5 md:pl-8 xl:pl-0">
                <h1 className={theme.title_white_before_yellow}>
                  O Viva Sinaf chegou!
                </h1>
                <p className="text-viva-bg xl:text-[16px] text-white mb-4">
                  Sua plataforma de saúde e bem-estar com benefícios que
                  facilitam o dia a dia:
                </p>
                <p className="flex items-baseline text-viva-bg xl:text-[16px] text-white mb-2">
                  <Image
                ...
                <p className="text-viva-bg xl:text-[16px] text-white mb-2">
          ...
          >
            <div className={`container-viva ${theme.hero_container}`}>
              <div className="md:w-3/5 md:pl-8 xl:pl-0">
                ...
                <p className="flex items-baseline text-viva-bg xl:text-[16px] text-dark mb-2">
                  <Image
                    src="/checkmark-square-2-outline 1.png"
                    alt="Checkmark"
                    width={16}
          ...
          <div
            className={`${styles.embla__slide} bg-[--primary-yellow] text-dark`}
          >
            <div className={`container-viva ${theme.hero_container}`}>
              <div className="md:w-3/5 md:pl-8 xl:pl-0">
